...
int main() {
  ...
  size_t one_line =
      my_very_long_counter * common_very_long_multiplier + my_very_long_counter;

  size_t multi_line = my_very_long_counter * common_very_long_multiplier +
                      another_very_long_counter * common_very_long_multiplier;
}
